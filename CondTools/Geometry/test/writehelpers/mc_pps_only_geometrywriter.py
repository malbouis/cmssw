...
process.load('Configuration.Geometry.GeometryExtended2021_CTPPS_SingleXML_cff')
...
process.XMLGeometryWriter = cms.EDAnalyzer("XMLGeometryBuilder",
                                           XMLFileName = cms.untracked.string('Geometry/VeryForwardData/data/2021/v1/pps.xml'),
...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
                                          process.CondDB,
                                          toPut = cms.VPSet(cms.PSet(record = cms.string('GeometryFileRcd'),tag = cms.string('XMLFILE_Geometry_111YV1_2021CTPPS_mc'))
                                                            )
                                          )
