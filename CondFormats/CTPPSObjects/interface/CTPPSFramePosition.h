...
#ifndef CondFormats_CTPPSObjects_CTPPSFramePosition_H
#define CondFormats_CTPPSObjects_CTPPSFramePosition_H
...
class CTPPSFramePosition
{
  public:
    ...
    CTPPSFramePosition(unsigned short SubSystemId, unsigned short TOTFEDId, unsigned short OptoRxId, unsigned short GOHId, unsigned short IdxInFiber) :
    ...
    CTPPSFramePosition(unsigned int pos = 0) : rawPosition(pos)
    {
    }
  ...
  public:
    bool operator < (const CTPPSFramePosition &pos) const
    {
    ...
    friend std::ostream& operator << (std::ostream& s, const CTPPSFramePosition &fp);
